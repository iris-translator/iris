...
use ruff::codegen::{round_trip, Stylist};
...
pub fn handle_ecma_to_python(alloc: &Allocator, origin: &str) -> Option<String> {
    ...
    let transformed = transformer.transformer.build_with_symbols_and_scopes(symbols, scopes, &mut program.program);
